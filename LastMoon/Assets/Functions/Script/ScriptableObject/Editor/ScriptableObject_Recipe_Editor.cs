...
[CustomEditor (typeof (ScriptableObject_Recipe))]
public class ScriptableObject_Recipe_Editor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        ScriptableObject_Recipe EditorObject = (ScriptableObject_Recipe)target;
